 ...
 * @author Ridwan
 */
public class laporan_data_penjualan_barang extends javax.swing.JFrame {
...
private DefaultTableModel tabmode;
    ...
    /**
     * Creates new form laporan_data_penjualan
     */
    public laporan_data_penjualan_barang() {
        initComponents();
        setLocationRelativeTo(null);
        datatable();
    }
 protected void datatable(){
    Object [] Baris = {"Kode Barang","Nama Barang","Jenis Barang","Harga Barang","Tanggal Transaksi",
        "Jumlah Barang","Total Harga","Bayar","Kembali"};
        tabmode = new DefaultTableModel(null, Baris);
        penjualan.setModel(tabmode);
        ...
        try {
            ...
            String g = hasil.getString("tgl_transaksi");
            String h = hasil.getString("jumlah_barang");
            String i = hasil.getString("total_harga");
            String z = hasil.getString("bayar");
            String x = hasil.getString("kembali");
            
            String[] data={a,s,d,f,g,h,i,z,x};
            tabmode.addRow(data);
        }
    } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("*Pencarian Berdasarkan kode_barang");
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        try {
            File file = new File("src/Report/Lap_Penjualan_Barang.jrxml");
    ...
    private void sActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sActionPerformed
        try
        {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM penjualan_barang WHERE kode_barang like '%"+search+"%' OR nama_barang like '%"+search+"%'");
            DefaultTableModel dtm = (DefaultTableModel)penjualan.getModel();
            ...
            data[4] = rs.getString("tgl_transaksi");
            data[5] = rs.getString("jumlah_barang");
            data[6] = rs.getString("total_harga");
            data[7] = rs.getString("bayar");
            data[8] = rs.getString("kembali");
    ...
    public static void main(String args[]) {
        ...
        UIManager.setLookAndFeel("com.jtattoo.plaf.aluminium.AluminiumLookAndFeel");
            ...
            java.util.logging.Logger.getLogger(laporan_data_penjualan_barang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
